...
namespace riscv {
	...
	struct boot_mmio_device : memory_segment<typename P::ux>
	{
		...
		constexpr u8* as_u8() { return (u8*)&build_riscv32_unknown_elf_bin_boot_rom_bin[0]; }
		constexpr u16* as_u16() { return (u16*)&build_riscv32_unknown_elf_bin_boot_rom_bin[0]; }
		constexpr u32* as_u32() { return (u32*)&build_riscv32_unknown_elf_bin_boot_rom_bin[0]; }
		constexpr u64* as_u64() { return (u64*)&build_riscv32_unknown_elf_bin_boot_rom_bin[0]; }

		/* BOOT constructor */

		boot_mmio_device(P &proc, UX mpa) :
			memory_segment<UX>("ROM", mpa, /*uva*/0,
				/*size*/build_riscv32_unknown_elf_bin_boot_rom_bin_len,
